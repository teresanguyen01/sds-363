...
```
*Based on the chi-square quantile plot, a large number of observation fall outside of the boundary (that is associated with if our data was multivariate normal) and follows a non-linear pattern, with the latter half curving upwards.*
